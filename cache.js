...
gaze('archive/**/*#*#*.MD', function(err, watcher) {
  ...
  this.on('changed', function(filepath) {
    if(logON) console.log(filepath + ' was changed');
  ...
  this.on('renamed',function(filepath){
	if(logON) console.log(filepath+' was renamed, use same function as add !!!(auto emit delete event)');
	//TODO SAME TO ADD
...
function add_callback(filepath) {
    if(logON) console.log(filepath + ' was added');
	...
	if(!article_timestamp_cache[name])
	{
		...
		timestamp_article_cache[stamp] = name;
	}
	if(logON) console.log(article_timestamp_cache);
	...
	if(logON) console.log(year_month_cache);
	...
	if(logON) console.log(year_month_article_cache);
}

function del_callback(filepath) {
    if(logON) console.log(filepath + ' was deleted');
	...
	if(article_timestamp_cache[name])
	{
		delete timestamp_article_cache[article_timestamp_cache[name]];
...
exports.LogON = function(arg){
	logON = arg;
};

exports.Article_Timestamp = function(){
	return article_timestamp_cache;
};

exports.Timestamp_Article = function(){
	return timestamp_article_cache;
};

exports.Article_Title = function(){
	return article_title_cache;
};

exports.Year_Month = function(){
	return year_month_cache;
};

exports.Year_Month_Article = function(){
	return year_month_article_cache;
};
